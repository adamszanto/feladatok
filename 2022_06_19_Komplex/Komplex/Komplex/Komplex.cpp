...
Legyen == és != operátor két Komplex szám egyenlőségének a vizsgálatához! 
A valós számok számítási pontatlanságai miatt egymáshoz egy bizonyos tűréshatárnál (legyen ez 10^10) közelebb lévő számokat tekintsünk egyenlőnek: 
|x-y|<10^10

*/ 

bool Komplex:: operator==(const Komplex& a)
{
    if (re == a.re, im == a.im)
    {
        return true;
